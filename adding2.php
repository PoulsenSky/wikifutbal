...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-danger">
			...
			<form action="" method="POST" autocomplete="off">
				<p> <h4 style="padding-right: 505px;"> ID Coach : </h4> 
					<input type="text" name="id" placeholder="Insert coach's ID..." required> </p>
				<p> <h4 style="padding-right: 529px;"> Name : </h4>
					<input type="text" name="namec" placeholder="Insert coach's name..." required> </p>
				<p> <h4 style="padding-right: 490px;"> Nationality : </h4>
					<input type="text" name="nationalityc" placeholder="Insert coach's nationality..." required></p>
				<p> <h4> Date Of Birth : </h4>
					<input type="date" name="birthc" min="1900-01-01" max="2100-12-31" required> </p>
				<p> <h4 style="padding-right: 465px;"> Club Managed : </h4>
					<input type="text" name="manage" placeholder="Insert coach's club..." required> </p>
					<hr>
