<?php	
	SESSION_START();
		...
		$c=query("SELECT * FROM coach WHERE id = $id")[0];
		...
		<body>
			...
			<form action="" method="POST" autocomplete="off">
				<p> <h4 style="padding-right: 505px;"> ID Coach : </h4> 
					...
					value="<?= $c['id']?>" required> </p>

				<p> <h4 style="padding-right: 529px;"> Name : </h4>
					<input type="text" name="namec" 
					value="<?= $c['namec']?>" required> </p>

				<p> <h4 style="padding-right: 490px;"> Nationality : </h4>
					<input type="text" name="nationalityc" 
					value="<?= $c['nationalityc']?>" required></p>

				<p> <h4> Date Of Birth : </h4>
					<input type="date" name="birthc" min="1900-01-01" max="2100-12-31" 
					value="<?= $c['birthc']?>" required> </p>

				<p> <h4 style="padding-right: 465px;"> Club Managed : </h4>
					<input type="text" name="manage" 
					value="<?= $c['manage']?>" required> </p>
